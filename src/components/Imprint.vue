  ...
  >
    <div class="p-8">
      ...
      <div class="text-center">
        ...
        E-Mail: lichteransgar@gmail.com<br />
      </div>
      <br />
      <hr>
      <br />
      ...
      Meine E-Mail-Adresse finden Sie oben im Impressum. Ich bin nicht bereit
      ...
      <hr>
      <br />
      <h1 class="text-3xl lg:text-3xl font-bold text-center mb-4">Urheberrecht</h1>
      ...
      <hr>
      <br />
      <h1 class="text-3xl lg:text-3xl font-bold text-center">Quelle:</h1>
      <div class="text-center">
        <a href="https://www.e-recht24.de/" target="_blank">eRecht24</a>
      </div>
    </div>
  </b-modal>
</template>
