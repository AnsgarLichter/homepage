...
const spyDirective = {
  ...
  mounted(element, binding) {
    ...
    instance.scrollContainer = new ScrollContainer(
      instance.options.scrollContainerSelector
    );
    instance.navigationLinkCollection = new NavigationLinkCollection(
      instance.options.navigationLinkSelector
    );

    instance.scrollContainer.addScrollListener(
      methods.onContainerScrolled.bind(instance)
    );
    instance.navigationLinkCollection.addClickListener(
      methods.onNavigationLinkClicked.bind(instance)
    );
